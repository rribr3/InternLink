...
public class StudentSettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvCompanyName = findViewById(R.id.tv_student_name);
        tvCompanyEmail = findViewById(R.id.tv_student_email);
        ...
        layoutDeactivateAccount.setOnClickListener(v -> {
            new AlertDialog.Builder(StudentSettingsActivity.this)
                    ...
                    .setPositiveButton("Yes", (dialog, which) -> {
                        ...
                        if (currentUser != null) {
                            ...
                            Toast.makeText(StudentSettingsActivity.this, "Account deactivated", Toast.LENGTH_SHORT).show();

                            startActivity(new Intent(StudentSettingsActivity.this, LoginActivity.class)
    ...
    private void fetchCompanyInfo() {
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(StudentSettingsActivity.this, "Failed to load info", Toast.LENGTH_SHORT).show();
            }
        });
    }
}